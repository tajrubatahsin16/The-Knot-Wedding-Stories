...
public class Uploadengagement_Item extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_uploadengagement__item);
        getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN,WindowManager.LayoutParams.FLAG_FULLSCREEN);
        //getSupportActionBar().hide();
        ItemImage = (ImageView) findViewById(R.id.iv_foodImage);
    ...
    public void uploadInfo(){
        ...
        FirebaseDatabase.getInstance().getReference("EngagementfoodInfo")
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                if(task.isSuccessful()){
                    Toast.makeText(com.example.knotwedding.Uploadengagement_Item.this, "Successfully Uploaded", Toast.LENGTH_SHORT).show();
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(com.example.knotwedding.Uploadengagement_Item.this,e.getMessage().toString(),Toast.LENGTH_SHORT).show();
