...
public class Uploadmainprogram_item extends AppCompatActivity {
    ...
    public void uploadInfo(){
        ...
        FirebaseDatabase.getInstance().getReference("MainprogramfoodInfo")
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                if(task.isSuccessful()){
                    Toast.makeText(com.example.knotwedding.Uploadmainprogram_item.this, "Successfully Uploaded", Toast.LENGTH_SHORT).show();
